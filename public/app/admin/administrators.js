$(function(){
    ...
    $('#form-create').formwizard({
        ...
        validationOptions: {
            ...
            messages: {
                ...
                'idtypeadministrator' : 'Por favor seleccione un tipo de administrador',
                'idarea': 'Por favor seleccione un area',
                'idcompany': 'Por favor seleccione una compania'}
        },
        inDuration: 0,
        outDuration: 0,
        textBack: 'Atras',
    ...
    $('#form-create').submit(function(e){
       ...
       if($('#form-create').valid()){
            CRUD.action(document.getElementById('form-create'), function(){
                $(Admin.$contenedor).load('admin/administrators',function(){
    ...
    function prepareStatus(e){
        var id = $(this).data('id');
        $('#div-status').load('admin/administrators/status/'+id,function(){
